...
conf['parameters_def'] = {'AR': {'min': 0, 'max': 12, 'step': 1},
                          ...
                          'Season_AR': {'min': 0, 'max': 6, 'step': 1},
                          'Season_D': [0, 1],
                          'Season_MA': {'min': 0, 'max': 6, 'step': 1},
                          'Season_Period': [1, 6, 12]
                          }


conf['experiment_name'] = 'SARIMAX - model_2 bbking Seasonal Order - '
conf[
    'description'] = ' explore the orders parameters with influence of the season SARIMAX on micro data'
